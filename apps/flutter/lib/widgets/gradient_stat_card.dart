...
class GradientStatCard extends StatelessWidget {
  ...
  (List<Color>, Color) _colors() {
    switch (tone) {
      case StatTone.green:
        return (AppColors.gradientGreen, AppColors.iconBgGreen);
      case StatTone.amber:
        return (AppColors.gradientAmber, AppColors.iconBgAmber);
      case StatTone.purple:
        return (AppColors.gradientPurple, AppColors.iconBgPurple);
      case StatTone.teal:
        return (AppColors.gradientTeal, AppColors.iconBgTeal);
      case StatTone.orange:
        return (AppColors.gradientOrange, AppColors.iconBgOrange);
      case StatTone.blue:
        return (AppColors.gradientBlue, AppColors.iconBgBlue);
    }
  }
